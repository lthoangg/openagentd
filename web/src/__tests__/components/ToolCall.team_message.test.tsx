...
// Mock lucide-react icons to avoid SVG rendering issues. Only icons ToolCall
// actually imports need stubs — previous entries (Loader2, CheckCircle2, Clock,
// Terminal) were dropped in the aside-style redesign.
